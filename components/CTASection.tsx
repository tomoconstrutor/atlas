  ...
  return (
    <section className="border-t border-[var(--color-rule)] px-4 py-16 sm:px-10 lg:py-24">
      <div className="mx-auto max-w-6xl">
        <SectionLabel number="05">{text(siteText.sections.cta, locale)}</SectionLabel>
        ...
        <div className="relative mt-10 overflow-hidden rounded-[20px] bg-mind-ink p-8 text-mind-bg shadow-mindLg sm:p-12">
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            {href ? (
              ...
              <button
                type="button"
                className="inline-flex min-h-12 cursor-default items-center justify-center rounded-full bg-mind-bg px-8 pb-2 pt-2.5 font-display text-2xl uppercase tracking-[0.04em] text-mind-ink opacity-75"
                aria-disabled="true"
